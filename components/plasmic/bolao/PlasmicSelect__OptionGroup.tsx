...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: oHFr2fPPs6z/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: Xmjnrrq0VJU/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__weoc)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__mcvK6)}
              />
            </React.Fragment>
          ),
          value: args.children
